...
function parse(text) {
  // Guard against selectors with unbalanced parentheses, which can cause
  // catastrophic backtracking in slick's parser (e.g., mensch incorrectly
  // splitting `:is(.a, .b)` into `:is(.a` and `.b)`).
